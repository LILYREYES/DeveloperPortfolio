...
/* No usamos JSX.Element ni JSX namespace para evitar dependencias en Astro */
const CategoryIcons: Record<string, any> = {
  ...
  /* añadida explícitamente para la categoría que usas en 'skills' */
...
/* fallback si la categoría no está definida */
const DefaultIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
    className="w-6 h-6 text-[var(--sec)] opacity-50"
  >
    <path d="M12 2L2 7l10 5 10-5-10-5zm0 7l-8-4 8-4 8 4-8 4zm0 6l-8-4v6l8 4 8-4v-6l-8 4z" />
  </svg>
);
...
const SkillsList = () => {
  ...
  const skills: Record<string, string[]> = {
    "Frontend and Backend Development": [
      ...
      "Collaboration with marketing, design, and sales teams to align technical execution with strategic goals.",
      "SEO optimization and performance enhancements for better UX and search engine rankings.",
    ],
    "Mobile Development": ["Mobile-friendly web apps", "Responsive design for various devices"],
    "Web Development": ["Single Page Applications (SPAs)", "Landing pages and business websites", "Portfolio websites"],
  };
